...
export default class UnitConfirmSourceMoadan extends Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    return (<ul className={classnames({ 'acms-admin-table-admin-edit acms-admin-table-admin-edit-bordered': acmscss })}>
      {customunit.map((item) => {
        if (!item.name) {
          return null;
        }
